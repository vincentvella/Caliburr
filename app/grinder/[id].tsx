...
const FAKE_AEROPRESS_RECIPES: (GrinderRecipe & GrinderStatRow)[] = [
  {
    ...
    yield_g: 220,
    upvotes: 32,
    bean: { name: 'Ethiopia Guji', roaster: 'Verve Coffee' },
    worked_tries: 5,
  },
  {
    id: 'fake-2',
    ...
    yield_g: 230,
    upvotes: 24,
    bean: { name: 'Colombia La Palma', roaster: 'Onyx Coffee Lab' },
    worked_tries: 3,
  },
  {
    id: 'fake-3',
    ...
    yield_g: 240,
    upvotes: 21,
    bean: { name: 'Kenya Nyeri', roaster: 'Sey Coffee' },
    worked_tries: 4,
  },
  {
    id: 'fake-4',
    ...
    yield_g: 220,
    upvotes: 18,
    bean: { name: 'Burundi Kayanza', roaster: 'George Howell' },
    worked_tries: 2,
  },
  {
    id: 'fake-5',
    ...
    yield_g: 200,
    upvotes: 16,
    bean: { name: 'Yemen Mocha', roaster: 'Mostra Coffee' },
    worked_tries: 2,
  },
  {
    id: 'fake-6',
    ...
    yield_g: 250,
    upvotes: 14,
    bean: { name: 'Brazil Daterra', roaster: 'Counter Culture' },
    worked_tries: 1,
  },
  {
    id: 'fake-7',
    ...
    yield_g: 230,
    upvotes: 12,
    bean: { name: 'Costa Rica Tarrazu', roaster: 'Heart Coffee' },
    worked_tries: 3,
  },
  {
    id: 'fake-8',
    ...
    yield_g: 210,
    upvotes: 9,
    bean: { name: 'Guatemala Huehue', roaster: 'Blue Bottle' },
    worked_tries: 1,
  },
];

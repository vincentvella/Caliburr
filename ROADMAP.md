...
- [x] **Privacy policy** — `app/privacy.tsx` screen exists; registered in `_layout.tsx` and exempt from auth gating; linked from sign-up and account settings; `PRIVACY_URL` referenced in terms screen.
